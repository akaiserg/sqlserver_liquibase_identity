...
--rollback DELETE FROM tte_person WHERE per_id = 4;
--rollback DELETE FROM tte_person WHERE per_id = 5;
--rollback DELETE FROM tte_person WHERE per_id = 6;
--rollback DBCC CHECKIDENT('tte_person', RESEED, 3);